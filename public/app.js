...
const backendUrl = 'https://your-app.onrender.com'; // Replace with your deployed backend URL
...
document.getElementById('download-button').addEventListener('click', async () => {
    ...
    try {
        ...
        if (data.downloadLink) {
            messageContainer.textContent = `Download simulated successfully! Link: ${data.downloadLink}`;
        } else {
            messageContainer.textContent = `Error: No download link available.`;
        }
    } catch (error) {
